...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_LOWER] = LAYOUT_preonic_grid(
		...
		_______, KC_LBRC,	KC_RBRC,	KC_MINS,	KC_EQL,		KC_SLSH, KC_PAUS, KC_P0,   KC_PDOT, KC_PCMM, KC_PSLS, RSFT_T(KC_PENT),
		_______, _______,	_______,	_______,	_______,	_______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END),

	/* Raise
	 */ // TODO: Move Math mode to the adjust layer so it is harder to accidently press
	...
	[_ADJUST] = LAYOUT_preonic_grid(
		...
		_______, _______, MU_MOD, AU_ON, AU_OFF, UNICODE_MODE_WIN,  _______,  _______, DF(_QWERTY),DF(_MOUSE),  PLOVER,  _______,
