...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_LOWER] = LAYOUT_preonic_grid(
		...
		_______, MEH(KC_F1), MEH(KC_F2),   MEH(KC_F3), MEH(KC_F4), KC_BSLS,          KC_PSCR, KC_P1,   KC_P2,  	KC_P3,  	 KC_PAST, KC_PEQL,
	...
	[_ADJUST] = LAYOUT_preonic_grid(
		...
		KC_CAPS, _______, MU_MOD,  AU_ON,   AU_OFF,  UNICODE_MODE_WIN, _______, DF(_NO_TRANSIENT), DF(_QWERTY), DF(_MOUSE),      PLOVER,            KC_LOCK,
