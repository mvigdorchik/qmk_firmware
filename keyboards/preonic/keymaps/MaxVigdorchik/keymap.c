...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* Lower
     */
    [_LOWER] = LAYOUT_preonic_grid(KC_F11,  KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,   KC_NLCK, KC_P7,   KC_P8,   KC_P9,   KC_PMNS, KC_BSPC,
    ...
    /* Raise
     */
    [_RAISE] = LAYOUT_preonic_grid(KC_F11,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,        KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_BSPC,
				   ...
				   _______, KC_LCBR, KC_RCBR, KC_LT,   KC_GT,   KC_SCLN, KC_COLN,      TG(_MATH), KC_MUTE, KC_MPLY, KC_VOLU, _______,
     ...
     */
    [_MOUSE] = LAYOUT_preonic_grid(XXXXXXX,  KC_MS_ACCEL0,KC_MS_ACCEL1,KC_MS_ACCEL2,XXXXXXX,     XXXXXXX,   XXXXXXX,XXXXXXX,      XXXXXXX,       XXXXXXX,       XXXXXXX,XXXXXXX,
    ...
    [_ADJUST] = LAYOUT_preonic_grid(KC_VOLD, KC_VOLU, KC_BRID, KC_BRIU, KC_PSCR, KC_SLCK,          KC_PAUS,           KC_INS,           _______,     DM_REC1,         DM_REC2,           DM_RSTP,
				    ...
				    _______, _______, MU_MOD,  AU_ON,   AU_OFF,  _______,          _______,           _______,          DF(_QWERTY),DF(_MOUSE),       PLOVER,            _______,
				    _______, MUV_DE,  MUV_IN,  MU_ON,   MU_OFF,  UNICODE_MODE_LNX, UNICODE_MODE_WINC, UNICODE_MODE_OSX, _______,     MAGIC_HOST_NKRO, MAGIC_UNHOST_NKRO, _______,
