...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 RCTL_T(KC_ESC),  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    CS_SNAKE,                 MENU_BTN,KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, RALT_T(KC_QUOT),
        KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    CW_TOGG,                  RGB_TOG, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT_T(KC_ENT),
    ...
    [_LOWER] = LAYOUT(
        KC_F11,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______,                   _______, KC_NUM,  KC_P7,   KC_P8,   KC_P9,   KC_PMNS, _______,
...
_______,MEH(KC_F1),MEH(KC_F2),MEH(KC_F3),MEH(KC_F4), KC_BSLS, _______,                   _______, KC_PSCR, KC_P1,   KC_P2,   KC_P3,   KC_PAST, KC_PEQL,
    ...
    [_RAISE] = LAYOUT(
        ...
        _______, KC_LBRC, KC_RBRC, KC_EQL,  KC_PLUS, KC_SLSH, _______,                   _______, KC_GRV,  KC_LEFT, KC_DOWN, KC_RIGHT,XXXXXXX, QK_LOCK,
    ...
    [_ADJUST] = LAYOUT(
        KC_F11 , KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______,                   _______, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  DM_RSTP,
        KC_F12 , RGB_SAD, RGB_VAI, RGB_SAI, QK_BOOT, RST_ROM, _______,                   _______, _______, KC_P7,   KC_P8,   KC_P9,   DM_REC1, DM_REC2,
        ...
        _______, RGB_RMOD,RGB_TOG, RGB_MOD, _______, _______, _______, _______, _______, _______, _______, KC_P0,   KC_PDOT, KC_NUM,  NO_TRNS,  QWERTY,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [_QWERTY] =        { ENCODER_CCW_CW(KC_RIGHT, KC_LEFT),  ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(_______, _______),
                         ENCODER_CCW_CW(KC_WH_R,  KC_WH_L),  ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(MENU_UP, MENU_DN) },

    [_NO_TRANSIENT] =  { ENCODER_CCW_CW(_______, _______),   ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(_______, _______),
                         ENCODER_CCW_CW(_______, _______),   ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(_______, _______) },

    [_LOWER] =         { ENCODER_CCW_CW(NEXT_TAB, PREV_TAB), ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(_______, _______),
                         ENCODER_CCW_CW(_______,  _______),  ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(_______, _______) },

    [_RAISE] =         { ENCODER_CCW_CW(KC_VOLU, KC_VOLD),   ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(_______, _______),
                         ENCODER_CCW_CW(_______, _______),   ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(_______, _______) },

    [_ADJUST] =        { ENCODER_CCW_CW(MENU_UP, MENU_DN),   ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(_______, _______),
                         ENCODER_CCW_CW(_______, _______),   ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(_______, _______) },

    [_BLANK] =         { ENCODER_CCW_CW(_______, _______),   ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(_______, _______),
                         ENCODER_CCW_CW(_______, _______),   ENCODER_CCW_CW(_______, _______), ENCODER_CCW_CW(_______, _______) },
};
#endif
